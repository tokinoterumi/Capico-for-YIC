<script>
	...
	onMount(() => {
		// Remove global manifest and replace with admin manifest
		const globalManifest = document.querySelector('link[rel="manifest"][href*="manifest.json"]');
		if (globalManifest) {
...
<svelte:head>
	...
	<link rel="apple-touch-icon" sizes="180x180" href="/Capico.png" />
</svelte:head>
